...
import { User, Mail, Phone, Calendar, Shield, MapPin, Cake, Save, ArrowLeft, Upload } from 'lucide-react';
...
export default function EditClientProfile() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const token = localStorage.getItem('token');
      const response = await axios.put('http://localhost:5000/api/client/profile', formData, {
        headers: {
          'Authorization': `Bearer ${token}`,
        },
      });
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-slate-200">Update your personal information</p>
                </div>
              </div>
